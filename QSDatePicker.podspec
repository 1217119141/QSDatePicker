...
Pod::Spec.new do |s|
  s.name             = 'QSDatePicker'
  s.version          = '0.1.0'
  s.summary          = 'A short description of QSDatePicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/qianshuai/QSDatePicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'qianshuai' => '1217119141@qq.com' }
  s.source           = { :git => 'https://github.com/qianshuai/QSDatePicker.git', :tag => s.version.to_s }
